 ...
 * node: 16
 * [@typescript-eslint/eslint-plugin][2]: ^5.57.0
 * [@typescript-eslint/parser][3]: ^5.57.0
 * [eslint][4]: ^8.37.0
 * [eslint-import-resolver-typescript][5]: ^3.5.4
 * [eslint-plugin-functional][6]: ^5.0.7
...
```sh
npm i @chubbyts/chubbyts-eslint@^1.0.0
```
